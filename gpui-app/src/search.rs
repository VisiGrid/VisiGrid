...
impl CommandId {
    ...
    pub fn name(&self) -> &'static str {
        match self {
            ...
            Self::HubCheckStatus => "Hub: Check Status",
            Self::HubPull => "Hub: Update from Remote",
            Self::HubPublish => "Hub: Publish",
            Self::HubOpenRemoteAsCopy => "Hub: Open Remote as Copy",
            Self::HubUnlink => "Hub: Unlink",
