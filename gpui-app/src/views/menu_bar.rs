...
fn render_file_menu(highlight: Option<usize>, text_primary: Hsla, text_muted: Hsla, selection_bg: Hsla, border: Hsla, cx: &mut Context<Spreadsheet>) -> Div {
    ...
    div()
        ...
        .child(menu_item_with_accel("Open Cloud...", None, Some('l'), 4, h(4), text_primary, text_muted, selection_bg, cx, |this, _window, cx| { this.close_menu(cx); this.cloud_open(cx); }))
        .child(menu_item_with_accel("Move to Cloud...", None, Some('m'), 5, h(5), text_primary, text_muted, selection_bg, cx, |this, _window, cx| { this.close_menu(cx); this.cloud_move_to_cloud(cx); }))
        .child(menu_separator(border))
        .child(menu_item("Export as CSV...", None, 6, h(6), text_primary, text_muted, selection_bg, cx, |this, _window, cx| { this.close_menu(cx); this.export_csv(cx); }))
...
fn render_view_menu(highlight: Option<usize>, text_primary: Hsla, text_muted: Hsla, selection_bg: Hsla, border: Hsla, cx: &mut Context<Spreadsheet>) -> Div {
    ...
    div()
        ...
        .child(menu_separator(border))
        .child(menu_item("Inspector", Some("Ctrl+Shift+I"), 1, h(1), text_primary, text_muted, selection_bg, cx, |this, _window, cx| { this.close_menu(cx); this.inspector_visible = !this.inspector_visible; if this.inspector_visible { this.profiler_visible = false; } cx.notify(); }))
        .child(menu_item("Profiler", Some("Ctrl+Alt+P"), 2, h(2), text_primary, text_muted, selection_bg, cx, |this, _window, cx| { this.close_menu(cx); this.profiler_visible = !this.profiler_visible; if this.profiler_visible { this.inspector_visible = false; } cx.notify(); }))
        .child(menu_separator(border))
        .child(menu_item("Zoom In", Some("Ctrl+Shift+="), 3, h(3), text_primary, text_muted, selection_bg, cx, |this, _window, cx| { this.close_menu(cx); this.zoom_in(cx); }))
        .child(menu_item("Zoom Out", Some("Ctrl+Shift+-"), 4, h(4), text_primary, text_muted, selection_bg, cx, |this, _window, cx| { this.close_menu(cx); this.zoom_out(cx); }))
        .child(menu_item("Reset Zoom", Some("Ctrl+0"), 5, h(5), text_primary, text_muted, selection_bg, cx, |this, _window, cx| { this.close_menu(cx); this.zoom_reset(cx); }))
        .child(menu_separator(border))
        ...
        .child(menu_item("Freeze First Column", None, 11, h(11), text_primary, text_muted, selection_bg, cx, |this, _window, cx| { this.close_menu(cx); this.freeze_first_column(cx); }))
        .child(menu_item("Freeze Panes", None, 12, h(12), text_primary, text_muted, selection_bg, cx, |this, _window, cx| { this.close_menu(cx); this.freeze_panes(cx); }))
