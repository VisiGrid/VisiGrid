...
pub fn default_keybindings() -> Vec<Keybinding> {
    vec![
        ...
        Keybinding { key: "ctrl+shift+c".into(), command: "edit.copyFormat".into(), when: None },
        Keybinding { key: "ctrl+shift+v".into(), command: "edit.pasteFormat".into(), when: None },
        Keybinding { key: "ctrl+alt+v".into(), command: "edit.pasteSpecial".into(), when: None },
        ...
        // Column sizing (via double-click header, no keyboard shortcut - Ctrl+0 used for zoom)
        ...
        // Cell inspector
        Keybinding { key: "ctrl+shift+i".into(), command: "view.inspectorAnalyze".into(), when: None },
        Keybinding { key: "ctrl+1".into(), command: "view.inspectorFormat".into(), when: None },

        // Named ranges
        Keybinding { key: "ctrl+shift+n".into(), command: "namedRange.define".into(), when: None },
        Keybinding { key: "f12".into(), command: "namedRange.goToDefinition".into(), when: None },

        // Formula Language Server
        Keybinding { key: "f1".into(), command: "help.showContext".into(), when: None },
        Keybinding { key: "shift+f12".into(), command: "references.findAll".into(), when: None },
        Keybinding { key: "ctrl+shift+r".into(), command: "symbol.rename".into(), when: None },

        // Lua REPL
        Keybinding { key: "ctrl+shift+l".into(), command: "repl.toggle".into(), when: None },

        // Number format shortcuts (Excel-style)
        Keybinding { key: "ctrl+shift+$".into(), command: "format.currency".into(), when: None },
        Keybinding { key: "ctrl+shift+%".into(), command: "format.percent".into(), when: None },
        Keybinding { key: "ctrl+shift+~".into(), command: "format.general".into(), when: None },
        Keybinding { key: "ctrl+shift+!".into(), command: "format.number".into(), when: None },

        // Text formatting
        Keybinding { key: "ctrl+5".into(), command: "format.strikethrough".into(), when: None },

        // Formula
        Keybinding { key: "f9".into(), command: "formula.recalculate".into(), when: None },

        // Zoom (Ctrl+= for in since + requires shift, Ctrl+0 for reset)
        // Note: Ctrl+- is used for delete row/col, so zoom out is menu-only
        Keybinding { key: "ctrl+=".into(), command: "view.zoomIn".into(), when: None },
        Keybinding { key: "ctrl++".into(), command: "view.zoomIn".into(), when: None },  // Also accept actual +
        Keybinding { key: "ctrl+0".into(), command: "view.zoomReset".into(), when: None },

        // Sheet navigation
        Keybinding { key: "ctrl+pagedown".into(), command: "sheet.next".into(), when: None },
        Keybinding { key: "ctrl+pageup".into(), command: "sheet.prev".into(), when: None },
    ]
}
