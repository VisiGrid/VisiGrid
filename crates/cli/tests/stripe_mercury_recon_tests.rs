...
/// Generated by `ensure_template`, so it goes in cargo's scratch dir rather
/// than the source tree — see the note in `abuse_tests.rs`.
fn template_path() -> PathBuf {
    Path::new(env!("CARGO_TARGET_TMPDIR")).join("stripe-mercury-recon.sheet")
}
